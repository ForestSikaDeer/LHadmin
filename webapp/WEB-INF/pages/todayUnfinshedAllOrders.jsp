...
<body class="hold-transition skin-purple sidebar-mini">
                        ...
                        <div class="box" id="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="todayAllOrder" items="${todayAllOrders}">
                                        <tr>
                                            <td>${todayAllOrder.orderId}</td>
                                            <td>${todayAllOrder.tableNumber}</td>
                                            <td>${todayAllOrder.orderName}</td>
                                            <td>${todayAllOrder.price}</td>
                                            <td>${todayAllOrder.status}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    <tfoot>
    ...
    <script>
        ...
        // 激活导航位置
        setSidebarActive("todayUnfinshedAllOrders");
    </script>
</body>
